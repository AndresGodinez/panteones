...
<div class="bs-example" data-example-id="static-dropdown"> 
	<div class="dropdown clearfix"> 
		...
		<li><?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Titular.id')), array(), __('Esta Seguro de eliminar'.$this->Form->value('Titular.fullname').'?', $this->Form->value('Titular.id'))); ?></li>
...
<?php echo $this->Form->create('Titular'); ?>
	<fieldset>
		<legend><?php echo __('Edit Titular'); ?></legend>
	<?php
